<template> 
   <div class="order-container">
    <div class="sidebar">
      <h3>订单中心</h3>
      <ul>
        <RouterLink to="/myorder" class="sidebar-link">
        <li>我的订单</li>
      </RouterLink>
        <RouterLink to="/afterSalesView/application" class="sidebar-link">
          <li><span style="color:#cc0c2d;">我的售后申请</span></li>
        </RouterLink>
  ...
  <script setup>
  import PageHead from '@/views/AfterSales/components/AfterSalesPageHead.vue';
  ...
  .order-container {display: flex;background-color: #fff;border-radius: 8px;box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);padding: 16px;margin: 16px;min-height: 500px;}
  ...
  .order-list th,
  .order-list td {border: 1px solid #ddd;padding: 6px;text-align: center;vertical-align: middle;font-size: 12px;}
